...
// --------------- modal from the given template URL
    ...
    .controller('ProfileCtrl', function ($scope, $rootScope, $ionicPlatform, auth, $window,
        ...
        $scope.checkPush = function() {
            var jwt = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJlNGM3MDlkMS03MjMzLTQxNWYtODI3Ni0xMmEwZDJkNjJiNmYifQ.OjpiJLVZwO1fe9JLnIBmb3AG6K3KLJbRjRtfHvkT5kE';
            var profile = '14mayproduction';
            var req = {
                method: 'GET',
                url: 'https://api.ionic.io/push/notifications/'+pushUUID+'/messages',
                headers: {
            ...
            console.log('Check push with req: ', req);
            // Make the API call
            $http(req).success(function(resp){
                // Handle success
                console.log("Ionic check Push: Check Push success", resp);
            }).error(function(error){
                // Handle error
                console.log("Ionic Check Push: Check Push error", error);
            });
        ...
        $scope.testPush = function() {
            ...
            var jwt = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJlNGM3MDlkMS03MjMzLTQxNWYtODI3Ni0xMmEwZDJkNjJiNmYifQ.OjpiJLVZwO1fe9JLnIBmb3AG6K3KLJbRjRtfHvkT5kE';
            var tokens = [];
            tokens.push($rootScope.myPushToken);
            var profile = '14mayproduction';
            ...
            var req = {
                ...
                data: {
                    ...
                    "notification": {
                        "title": "Test Push",
                        "message": "A Test Push message!",
                        "android": {
                            "title": "Android test",
                            "message": "Hello Android! Test Push"
                        },
                        "ios": {
                            "title": "iOS test push",
                            "message": "Hello iOS! Test Push"
                        }
                    }
                }
            };

            console.log('Test push with req: ', req);
            // Make the API call
            $http(req).success(function(resp){
                // Handle success
                console.log("Ionic Push: Push success", resp);
                pushUUID = resp.data.uuid;
            }).error(function(error){
                // Handle error
