...
angular.module('guru', ['ngCordova'])
    ...
    .controller('GuruDetailCtrl', ['$scope', 'auth', '$sanitize', '$ionicPlatform', 'GuruService', '$stateParams', '$ionicModal',
        'UserSettings', 'UserStorageService', 'wordpressAPI', 'wordpressConfig', '$sce', '$cordovaSocialSharing',
        function ($scope, auth, $sanitize, $ionicPlatform, GuruService, $stateParams, $ionicModal,
                  UserSettings, UserStorageService, wordpressAPI, wordpressConfig, $sce, $cordovaSocialSharing) {
    'use strict';
    $scope.noItems = false;
    ...
    .controller('GuruCtrl', ['$scope', 'GuruService', function ($scope, GuruService) {
    'use strict';
    $scope.posts = [];
